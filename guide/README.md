...
<b> ★ Step 1. Students seeking <b> competition guidance, research mentorship or academic development support </b> may send an email to [dt@hibiuh.edu.cn](mailto:dt@hibiuh.edu.cn) (or directly send email to the potential supervisors in the DT Teacher List below). </b>
...
3. The academic background of the supervisor you hope to work with (you may also identify potential supervisors from the DT Teacher List below and include their names in your email)
...
* Auwal Sagir Muhammad \| auwal.muhammad@hibiuh.edu.cn \| Cluster Computing, Web Technologies, Big Data \| PhD in Computer Science and Technology from Xiamen University, with research interests including deep learning, traffic risk assessment, environmental impact analysis, and data synthesis
